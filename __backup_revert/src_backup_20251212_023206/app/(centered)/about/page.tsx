...
export const metadata: Metadata = {
  title: 'About',
  description:
    'Learn more about Nick Treffiletti and his work in platform architecture and engineering.',
};
  ...
  return (
    ...
    >
      <div className="prose prose-slate max-w-none dark:prose-invert">
        ...
        <p>
          I&apos;m a platform architect and engineering leader with a passion for building developer
          platforms, cloud-native infrastructure, and scalable systems.
        </p>
        ...
        <p>
          Through this blog, I share insights, lessons learned, and opinionated takes on the
          evolving landscape of platform engineering.
        </p>
